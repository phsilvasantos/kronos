unit uFrmConsultaContatoReceita;
...
type
  TFrmConsultaContatoReceita = class(TForm)
    Panel2: TPanel;
    Label2: TLabel;
    Label3: TLabel;
    Label4: TLabel;
...
var
  FrmConsultaContatoReceita: TFrmConsultaContatoReceita;

implementation

{$R *.dfm}

procedure TFrmConsultaContatoReceita.ButBuscarClick(Sender: TObject);
var
  I: Integer;
begin
...
procedure TFrmConsultaContatoReceita.EditCaptchaKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    ButBuscarClick(ButBuscar);
end;

procedure TFrmConsultaContatoReceita.FormShow(Sender: TObject);
begin
  Timer1.Enabled:= True;
end;

procedure TFrmConsultaContatoReceita.LabAtualizarCaptchaClick(Sender: TObject);
var
...
procedure TFrmConsultaContatoReceita.Timer1Timer(Sender: TObject);
begin
